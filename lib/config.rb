...
module Config
  ...
  class Driver
    ...
    def initialize(browser)
      ...
      Selenium::WebDriver::Firefox.driver_path = drivers[self.actual_os][:firefox]
      Selenium::WebDriver::Chrome.driver_path = drivers[self.actual_os][:chrome]
    ...
    def browser_valid?
      !drivers[self.actual_os][browser].nil?
    end
