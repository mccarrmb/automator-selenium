...
Rake::TestTask.new(:chrome) do |t|
  t.warning = false
  t.libs = %w[lib test pages lib/clients/chrome]
...
Rake::TestTask.new(:firefox) do |t|
  t.warning = false
  t.libs = %w[lib test pages lib/clients/firefox]
  t.test_files = FileList['test/**/*_test.rb']
end
...
Rake::TestTask.new(:safari) do |t|
  t.warning = false
  t.libs = %w[lib test pages lib/clients/safari]
  t.test_files = FileList['test/**/*_test.rb']
end
...
Rake::TestTask.new(:edge) do |t|
  t.warning = false
  t.libs = %w[lib test pages lib/clients/edge]
  t.test_files = FileList['test/**/*_test.rb']
end
