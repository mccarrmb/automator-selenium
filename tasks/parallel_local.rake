...
Rake::TestTask.new(:chrome_parallel) do |t|
  t.warning = false
  t.libs = %w[lib test pages lib/clients/chrome_parallel]
...
Rake::TestTask.new(:firefox_parallel) do |t|
  t.warning = false
  t.libs = %w[lib test pages lib/clients/firefox_parallel]
  t.test_files = FileList['test/**/*_test.rb']
end
...
Rake::TestTask.new(:edge_parallel) do |t|
  t.warning = false
  t.libs = %w[lib test pages lib/clients/edge_parallel]
  t.test_files = FileList['test/**/*_test.rb']
end
